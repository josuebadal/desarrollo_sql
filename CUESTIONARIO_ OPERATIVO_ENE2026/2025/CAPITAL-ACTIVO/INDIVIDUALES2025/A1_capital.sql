...
act_eco_pld                                varchar, ---ADD ENERO 2026
...
y:=0;
insert into copiar values(y,'anio;clave_formulario;clave_de_entidad;tipo_cliente_o_usuario;clasificacion_grado_riesgo;pais_nacionalidad;pais_residencia;entidad_federativa_residencia;act_eco_pld;numero_total_clientes');
y:=1;
...
for r_paso in select * from
        ...
        left join trabajo tr ON  p.idorigen = tr.idorigen AND p.idgrupo = tr.idgrupo AND p.idsocio = tr.idsocio AND tr.consecutivo = 1
