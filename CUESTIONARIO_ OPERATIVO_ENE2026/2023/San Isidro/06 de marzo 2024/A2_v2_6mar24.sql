...
*/
  ...
  create temp table tmp_act as
    ...
    UNION
    select distinct idorigen, idgrupo, idsocio from servicios_d where idproducto=615 and periodo::integer >= 202300 and periodo::integer <202400;
...
create temp table temp_remesas as 
                                    select idorigen, idgrupo, idsocio, idcuestionario, peps
                                      from (select distinct idorigen, idgrupo, idsocio, 27 as idcuestionario from servicios_d where idproducto=615 and periodo::integer >= 202300 and periodo::integer <202400 ) rm
