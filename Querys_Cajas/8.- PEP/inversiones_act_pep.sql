/*1.-Relacion de socios con creditos activos al cierre de septiembre que contenga lo siguientes datos: numero de socio, nombre del socio, plazo, monto del credito otorgado, saldo de adeudos (saldo actual del credito), grado de riesgo, si fue catalogado como PEP.*/
select 
...
where aux.estatus =2
--FECHA ED APERTURA A FINAL DE MES HACIA ATRAS 
