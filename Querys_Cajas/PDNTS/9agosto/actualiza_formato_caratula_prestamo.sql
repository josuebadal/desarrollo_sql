----- AUTORIZAMOS EL CAMBIO -----
UPDATE tablas 
SET tipo = -456
WHERE idtabla = 'param'
AND idelemento = 'formato_caratula_prestamo';

----- CAMBIA EL DATO PARA ACTUALIZAR -----
UPDATE tablas 
SET tipo = 0
WHERE idtabla = 'param'
AND idelemento = 'formato_caratula_prestamo';

----- INSERTAMOS EL FORMATO -----
UPDATE tablas
            ...
            <script type="text/javascript">       
                ...
                if(@@idproducto@@==32102 || @@idproducto@@==31902) {                             
                 ...
                 comisiones.innerHTML ="ESTE PRODUCTO NO GENERA NINGUNA COMISI&Oacute;N";        
                   advertencia.innerHTML="Advertencia: En caso de no contratar el seguro de auto se cancelar&aacute; el cr&eacute;dito.";                                                                                                                                                                         
                 }                                
...
----- REGRESAMOS EL PARA METRO QUE INHABILITA MODIFICACIONES -----
UPDATE tablas 
SET tipo = 3
WHERE idtabla = 'param'
AND idelemento = 'formato_caratula_prestamo';