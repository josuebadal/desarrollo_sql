SELECT 
        ...
        acte.id_actividad as "id_act_eco_socio",
        acte.descripcion  as "act_eco_socio",
 ...
 FROM personas p                                                                              
      ...
      LEFT JOIN trabajo tr ON tr.idorigen = p.idorigen and tr.idgrupo = p.idgrupo and tr.idsocio = p.idsocio AND tr.consecutivo = 1
       LEFT JOIN actividades_economicas_pld acte on tr.actividad_economica_pld =  acte.id_actividad
