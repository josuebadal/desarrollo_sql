/* 
select sai_reporte_operacion_relevante_inusual_preocupante(202510, 202512, 1, '000001');

Validar la funcion en SAICOOP
param / reportes_regulatorios
select * from tablas where idtabla = 'param' and idelemento LIKE'reportes_%';
*/
