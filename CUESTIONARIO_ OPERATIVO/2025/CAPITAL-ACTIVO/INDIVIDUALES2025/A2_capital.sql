...
create type numero_clientes_usuarios_operaron_periodo as (
  ...
  pais_nacionalidad                 integer,---ADD ENERO 2026
  pais_residencia                   integer,---ADD ENERO 2026
  entidad_federativa_residencia     integer,---ADD ENERO 2026
...
begin
  ...
  CREATE temp table copiar(
      ...
      fila  text);
  y:=0;
  insert into copiar values(y,'anio;clave_formulario;clave_entidad;producto_servicio;tipo_cliente_usuario;clasificacion_grado_riesgo;pais_nacionalidad;pais_residencia;entidad_federativa;act_economica;numero_clientes_usuarios');
  y:=1;
