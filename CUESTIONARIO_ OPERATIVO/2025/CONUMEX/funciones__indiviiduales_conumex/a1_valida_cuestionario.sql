...
----- VALIDA LOS SOCIOS QUE SON PPE

select * from tmp_act_peps where peps <>0;
...
Las personas marcas como PPE son personas que cuyos datos son personas que se validan de la siguiente manera:
1.-Valida el CURP del Socio en caso de ser igual a una CURP de un PPE encuentra la similitud y lo marca como PPE
2.-En caso de que la CURP este Vacia o SEA DIFERENTE Compara el RFC en caso de ser igual a un RFC de un PPE encuentra la similitud
3.-En caso de que la CURP este Vacia o SEA DIFERENTE Compara los nombre del socio en caso de ser igual el NOMBRE de un PPE encuentra la similitud
