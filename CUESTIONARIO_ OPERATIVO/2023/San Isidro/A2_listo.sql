...
create type numero_clientes_usuarios_operaron_periodo as (
  ...
  tipo_cliente_usuario        text,--integer,
...
*/
  ...
  loop
    ...
    for r_paso in
      select *
      from (select count(*) as num_cli, tipoc, nries, espep
    ...
    loop
      ...
      r.tipo_cliente_usuario              := r_paso.tipoc||' '||r_paso.espep;
