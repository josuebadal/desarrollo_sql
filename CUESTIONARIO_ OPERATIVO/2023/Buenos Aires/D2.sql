...
/*	drop table if exists temp_productos;
	...
	create temp table temp_auxi as 
		(select a.*/*, te.idcuestionario*/
		 ...
		 where a.idproducto=101 and a.saldo=1500 and 
		 to_char(date(a.fechaape),'YYYYMM'):: integer between p_inicial and p_final
