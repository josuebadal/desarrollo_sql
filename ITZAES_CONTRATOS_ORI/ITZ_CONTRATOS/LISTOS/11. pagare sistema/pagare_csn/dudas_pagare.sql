...
<amortizaciones|idamortizacion,vence,abono,io,iva,anualidad,total>

<amortizaciones|numero_pago,corte,abono_principal,anualidad,saldo_insoluto,ios,ivas,monto_total>
...
<tasaim_anual.sql|>% 
<tasaim_anual|letra>
<direccion_origenp.sql|> a  
<fechaapertura|dd>  
dias del mes de <fechaapertura|ml>  
del ano <fechaapertura|aaaa>.<rellenar>
<amort_fecha_ultimo|ml>
<fecha_primer_pago|dd> de 
<fecha_primer_pago|ml> de 
<fecha_primer_pago|aaaa>
<reca_recortado_p|||D> 
<numero_contrato_condusef>